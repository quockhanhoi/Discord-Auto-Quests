...
interface Gateway {
    ...
    on(event: WebSocketShardEvents.Dispatch, listener: (...params: ManagerShardEventsMap$1[WebSocketShardEvents.Dispatch]) => Awaitable<void>): this;
...
interface WithIntrinsicProps<Data> extends IntrinsicProps {
    data: Data;
}
...
interface RequestGuildMembersResult {
...
declare class Client extends AsyncEventEmitter<MappedEvents> {
     ...
     * ```
     */
    requestGuildMembersIterator(options: GatewayRequestGuildMembersData, timeout?: number): AsyncGenerator<{
        members: discord_api_types_v10.APIGuildMember[];
        nonce: string;
        notFound: unknown[] | null;
        presences: discord_api_types_v10.GatewayGuildMembersChunkPresence[] | null;
        chunkIndex: number;
        chunkCount: number;
    }, void, unknown>;
    /**
     ...
     * ```
     */
    requestGuildMembers(options: GatewayRequestGuildMembersData, timeout?: number): Promise<{
        members: discord_api_types_v10.APIGuildMember[];
        nonce: string;
        notFound: unknown[];
