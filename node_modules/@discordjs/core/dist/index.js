...
var GuildsAPI = class {
  ...
  async get(guildId, queryOrOptions = {}, options = {}) {
    ...
    return this.rest.get(import_v104.Routes.guild(guildId), requestData);
  }
  /**
  ...
  async editUserVoiceState(guildId, userId, body, { reason, signal } = {}) {
    await this.rest.patch(import_v104.Routes.guildVoiceState(guildId, userId), { reason, body, signal });
  }
  /**
...
var Client = class extends import_async_event_emitter.AsyncEventEmitter {
  ...
  async *requestGuildMembersIterator(options, timeout = 1e4) {
    ...
    try {
      const iterator = import_async_event_emitter.AsyncEventEmitter.on(this, import_v1017.GatewayDispatchEvents.GuildMembersChunk, { signal: controller.signal });
