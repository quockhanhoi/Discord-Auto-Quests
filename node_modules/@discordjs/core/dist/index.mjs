...
var StageInstancesAPI = class {
  ...
  async create(body, { reason, signal } = {}) {
    return this.rest.post(Routes11.stageInstances(), {
      body,
      reason,
      signal
    });
   ...
   */
  async get(channelId, { signal } = {}) {
    return this.rest.get(Routes11.stageInstance(channelId), { signal });
  }
  /**
  ...
  async edit(channelId, body, { reason, signal } = {}) {
    return this.rest.patch(Routes11.stageInstance(channelId), {
      body,
      reason,
      signal
    });
  ...
  async delete(channelId, { reason, signal } = {}) {
    await this.rest.delete(Routes11.stageInstance(channelId), { reason, signal });
  }
};
...
var StickersAPI = class {
  ...
  async getStickers({ signal } = {}) {
    return this.rest.get(Routes12.stickerPacks(), { signal });
  }
  /**
   * Fetches all of the sticker packs
   *
  ...
  async get(stickerId, { signal } = {}) {
    return this.rest.get(Routes12.sticker(stickerId), { signal });
  }
};
...
var ThreadsAPI = class {
  ...
  async join(threadId, { signal } = {}) {
    await this.rest.put(Routes13.threadMembers(threadId, "@me"), { signal });
  }
  /**
  ...
  async addMember(threadId, userId, { signal } = {}) {
    await this.rest.put(Routes13.threadMembers(threadId, userId), { signal });
  }
  /**
  ...
  async leave(threadId, { signal } = {}) {
    await this.rest.delete(Routes13.threadMembers(threadId, "@me"), { signal });
  }
  /**
  ...
  async removeMember(threadId, userId, { signal } = {}) {
    await this.rest.delete(Routes13.threadMembers(threadId, userId), { signal });
  }
  /**
  ...
  async getMember(threadId, userId, { signal } = {}) {
    return this.rest.get(Routes13.threadMembers(threadId, userId), { signal });
  }
  /**
  ...
  async getAllMembers(threadId, { signal } = {}) {
    return this.rest.get(Routes13.threadMembers(threadId), { signal });
  }
};
...
var UsersAPI = class {
  ...
  async get(userId, { signal } = {}) {
    return this.rest.get(Routes14.user(userId), { signal });
  }
  /**
   ...
   */
  async getCurrent({ signal } = {}) {
    return this.rest.get(Routes14.user("@me"), { signal });
  }
  /**
  ...
  async getGuilds(query = {}, { signal } = {}) {
    return this.rest.get(Routes14.userGuilds(), {
  ...
  async leaveGuild(guildId, { signal } = {}) {
    await this.rest.delete(Routes14.userGuild(guildId), { signal });
  }
  /**
  ...
  async edit(body, { signal } = {}) {
    return this.rest.patch(Routes14.user("@me"), { body, signal });
  }
  /**
  ...
  async getGuildMember(guildId, { signal } = {}) {
    return this.rest.get(Routes14.userGuildMember(guildId), { signal });
  }
  /**
  ...
  async editCurrentGuildMember(guildId, body = {}, { reason, signal } = {}) {
    return this.rest.patch(Routes14.guildMember(guildId, "@me"), {
      reason,
      body,
      signal
    });
  ...
  async createDM(userId, { signal } = {}) {
    return this.rest.post(Routes14.userChannels(), {
  ...
  async getConnections({ signal } = {}) {
    return this.rest.get(Routes14.userConnections(), { signal });
  }
  /**
  ...
  async getApplicationRoleConnection(applicationId, { signal } = {}) {
    return this.rest.get(Routes14.userApplicationRoleConnection(applicationId), {
      signal
    });
  }
  /**
  ...
  async updateApplicationRoleConnection(applicationId, body, { signal } = {}) {
    return this.rest.put(Routes14.userApplicationRoleConnection(applicationId), {
      body,
      signal
    });
  }
...
// src/api/voice.ts
import { Routes as Routes15 } from "discord-api-types/v10";
var VoiceAPI = class {
  constructor(rest) {
    this.rest = rest;
  }
  ...
  async getVoiceRegions({ signal } = {}) {
    return this.rest.get(Routes15.voiceRegions(), { signal });
  }
};
...
var Client = class extends AsyncEventEmitter {
   ...
   * ```
   */
  async *requestGuildMembersIterator(options, timeout = 1e4) {
    ...
    const createTimer = /* @__PURE__ */ __name(() => setTimeout(() => {
      controller.abort();
    }, timeout), "createTimer");
